...
RowLayout {
    ...
    Item {
        ...
        GeneratorLattice {
            ...
            // uniforms
            squareInPixels: latticeView.ppc
            ...
            function setMask(colX, colY, colW, colH) {
                ...
                if (latticeView.currRegion.type === -1) return mask = Qt.vector4d(-1, -1, -1, -1);
                ...
                if (latticeView.currRegion.type === 0) element = inputModel.get(latticeView.currRegion.index);
                else if (latticeView.currRegion.type === 1) element = outputModel.get(latticeView.currRegion.index);
