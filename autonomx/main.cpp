...
int main(int argc, char *argv[]) {
    ...
    const char* applicationVersion = "1.0.1";
    ...
    qmlRegisterUncreatableMetaObject(PatternTypeNS::staticMetaObject, "ca.hexagram.xmodal.autonomx", 1, 0, "GOLPatternType", "Cannot instanciate GOLType.");
