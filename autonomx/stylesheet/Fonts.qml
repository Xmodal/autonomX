...
QtObject {
    ...
    readonly property font rackLabel: Qt.font({ family: "Archivo", pixelSize: 16, letterSpacing: 16 * 0.05, capitalization: Font.AllUppercase })
    ...
    readonly property font title: Qt.font({ family: "Archivo", pixelSize: 20, weight: Font.Medium, letterSpacing: 20 })
}
