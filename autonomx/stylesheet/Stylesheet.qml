...
QtObject {
    ...
    property QtObject fonts: QtObject {
        ...
        readonly property font fieldText: Qt.font({ family: "Archivo", pixelSize: 16, weight: Font.Medium, letterSpacing: 16 * 0.02 })
        readonly property font title: Qt.font({ family: "Archivo", pixelSize: 20, weight: Font.Medium, letterSpacing: 20 * 0.02 })
    }
